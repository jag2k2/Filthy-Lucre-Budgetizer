...
<Library LVVersion="18008000">
	...
	<Item Name="Create Msg Queue.vi" Type="VI" URL="../Create Msg Queue.vi"/>
	<Item Name="Destroy Queue.vi" Type="VI" URL="../Destroy Queue.vi"/>
	<Item Name="Last Ack.vi" Type="VI" URL="../Last Ack.vi"/>
	<Item Name="Message.ctl" Type="VI" URL="../Message.ctl"/>
	<Item Name="Preview Next Msg.vi" Type="VI" URL="../Preview Next Msg.vi"/>
	<Item Name="Read Next Msg.vi" Type="VI" URL="../Read Next Msg.vi"/>
	<Item Name="Send Msg.vi" Type="VI" URL="../Send Msg.vi"/>
</Library>
